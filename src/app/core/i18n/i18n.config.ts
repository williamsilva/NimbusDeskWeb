...
export const CHANNEL_NAME = 'nimbusdesk-i18n';
export const LANG_KEY = 'nimbusdesk.i18n.lang';
export const EVENT_KEY = 'nimbusdesk.i18n.event';
export const LOCALE_COOKIE = 'NIMBUSDESK_LOCALE';
