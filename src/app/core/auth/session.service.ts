...
export class SessionService {
  private static readonly EXPIRES_AT_KEY = 'nimbusdesk.session.expiresAt';
  private static readonly EVENT_KEY = 'nimbusdesk.session.event';
  private static readonly CHANNEL_NAME = 'nimbusdesk-session';
  private static readonly LOGIN_REDIRECT_LOCK_KEY = 'nd_login_redirect_lock';
