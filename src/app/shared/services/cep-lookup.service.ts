 ...
 * chave/autenticação. Chamada direto do navegador, fora do BFF: não é dado do NimbusDesk, não
 * precisa de sessão/cookie/CSRF, e os interceptors de credentials/csrf só atuam em URLs do
 * próprio bff/api (ver isNimbusDesk() em credentials.interceptor.ts/csrf.interceptor.ts), então essa
