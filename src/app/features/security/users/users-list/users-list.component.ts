...
export class UsersListComponent extends StatefulListPage<UsersFiltersState, UsersAdvancedFilters> implements OnInit {
  ...
  protected override tableStateKey(): string {
    return STATE_KEY.NIMBUSDESK.SECURITY.USERS.TABLE.STATE.V1;
  }

  protected override tableRowsKey(): string {
    return STATE_KEY.NIMBUSDESK.SECURITY.USERS.TABLE.ROWS.V1;
  }

  protected override filtersKey(): string {
    return STATE_KEY.NIMBUSDESK.SECURITY.USERS.FILTERS.V1;
  }
