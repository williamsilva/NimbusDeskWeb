...
export class UsersCreateDialogComponent {
  ...
  constructor() {
    ...
    effect(() => {
      ...
      // AdminUserResponse.groups só traz grupos do NimbusDesk (o backend já filtra por appKey e
      // funde com os grupos de outros apps no update - ver AdminUserService.update no
      // NimbusDeskServer), então não há nada pra separar aqui.
      const nimbusdeskGroupIds = groupsRaw
