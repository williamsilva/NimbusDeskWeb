...
> implements OnInit {
  ...
  protected override tableStateKey(): string {
    return STATE_KEY.NIMBUSDESK.SECURITY.GROUPS.TABLE.STATE.V1;
  }

  protected override tableRowsKey(): string {
    return STATE_KEY.NIMBUSDESK.SECURITY.GROUPS.TABLE.ROWS.V1;
  }

  protected override filtersKey(): string {
    return STATE_KEY.NIMBUSDESK.SECURITY.GROUPS.FILTERS.V1;
  }
