...
export class GroupsApiService {
  ...
  searchPaged(body: ListQueryDto<GroupsAdvancedFilters>) {
    // appKey é sempre fixado aqui (nunca escolhido pelo usuário) — a tela de grupos do NimbusDesk
    // não deve listar grupos de outros apps Nimbus (ex.: NimbusDesk), mesmo que o catálogo de
