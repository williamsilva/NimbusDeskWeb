...
> implements OnInit {
  ...
  protected override tableStateKey(): string {
    return STATE_KEY.NIMBUSDESK.SETTINGS.EMAIL_LOG.TABLE.STATE.V1;
  }

  protected override tableRowsKey(): string {
    return STATE_KEY.NIMBUSDESK.SETTINGS.EMAIL_LOG.TABLE.ROWS.V1;
  }

  protected override filtersKey(): string {
    return STATE_KEY.NIMBUSDESK.SETTINGS.EMAIL_LOG.FILTERS.V1;
  }
